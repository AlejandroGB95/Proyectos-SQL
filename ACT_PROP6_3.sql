...
SQL> set pagesieze 150
SP2-0158: unknown SET option "pagesieze"
...
SQL> update emple set salario= salario+100,comision=comision+10 where dpt_no=10;
update emple set salario= salario+100,comision=comision+10 where dpt_no=10
                                                                 *
ERROR at line 1:
ORA-00904: "DPT_NO": invalid identifier 


SQL> update emple set salario= salario+100,comision=comision+10 where dept_no=10;
...
---------- ---------- ---------- ---------- -------- ---------- ---------- ----------                                                                 
      ...
      7654 MARTIN     VENDEDOR         7698 29/09/91       1600       1020         30                                                                 
      7698 NEGRO      DIRECTOR         7839 01/05/91       3005                    30                                                                 
      7782 CEREZO     DIRECTOR         7839 09/06/91       2985                    10                                                                 
      7788 GIL        ANALISTA         7566 09/11/91       3000                    20                                                                 
      7839 REY        PRESIDENTE            17/11/91       4200                    10                                                                 
      7844 TOVAR      VENDEDOR         7698 08/09/91       1350          0         30                                                                 
      7876 ALONSO     EMPLEADO         7788 23/09/91       1430                    20                                                                 
      7900 JIMENO     EMPLEADO         7698 03/12/91       1335                    30                                                                 
      7902 FERNANDEZ  ANALISTA         7566 03/12/91       3000                    20                                                                 
      7934 MU¥OZ      EMPLEADO         7782 23/01/92       1790                    10                                                                 
...
SQL> update emple set salario= salario+100,comision=nvl(comision,0)+10 where dept_no=10;
